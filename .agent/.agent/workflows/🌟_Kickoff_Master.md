...
0. **Infrastructure Setup**: 
   - `management/` および `product/` ディレクトリを物理的に作成する。
   - `🌟_Portal_Generator_Master` を起動し、空のプロジェクトポータルを作成する。
   「器（Infrastructure）」を最初に用意することで、3層構造の統治を開始する。
...
3. **Dashboard Setup**: 計画完了の通知を受け、`master-reporter` を起動する。
   ...
   - `management/00_Master_Report/00_Master_Report.md` として出力する。
...
・ `00_Master_Report.md` (ダッシュボード: `management/00_Master_Report/`)
